    ...
    <div class="card border-0" style="background-color: transparent">
        <div class="card-body p-0" >
            <div class="row position-relative">
                <div class="col-2 card" style="background-color: #fff; overflow: auto; -ms-overflow-style: none;  scrollbar-width: none; border: none">
                ...
                <div class="col-10"  style="max-height: 70vh!important; overflow: auto; -ms-overflow-style: none;  scrollbar-width: none; padding: 0!important;">
                    <div class="row" style="padding-top: 20px; ">
                        @forelse($products as $product)
                            <div wire:click.prevent="selectProduct({{ $product }})" class="col-lg-4 col-md-4 col-xl-3"
